...
- **[secrets.md](./secrets.md)** - platform secret management: plaintext `.dev.vars` locally,
  GitHub Actions secrets in prod, and the platform-secrets-vs-end-user-bucket-credentials distinction.
